...
//     // const auxModel = mongoose.model(_.capitalize(auxType), HorseSchema);

//     console.log("API :: ROUTING: Get auxiliary "+auxId+" ("+auxType+") for userId:",userId);

//     models[auxType].findById(auxId)
//     .then(data=>{
//         console.log("Successfully loaded auxiliary data:",data)
//         res.json(data);
//     })
//     .catch(err=>{
//         console.log("Failed to load auxiliary data:",err)
//     })
// })
